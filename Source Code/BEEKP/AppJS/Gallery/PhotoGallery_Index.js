jQuery(document).ready(function () {
    Metronic.init();
    TableAdvanced_PhotoActive();
    TableAdvanced_PhotoInactive();
});


function TableAdvanced_PhotoActive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblPhotoActive");
...
function TableAdvanced_PhotoInactive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblPhotoInactive");
