jQuery(document).ready(function () {
    Metronic.init();
    TableAdvanced_EventActive();
    TableAdvanced_EventInactive();
});


function TableAdvanced_EventActive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblEventActive");
...
function TableAdvanced_EventInactive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblEventInactive");
