jQuery(document).ready(function () {
    Metronic.init();
    TableAdvanced_NewsActive();
    TableAdvanced_NewsInactive();
});


function TableAdvanced_NewsActive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblNewsActive");
...
function TableAdvanced_NewsInactive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblNewsInactive");
