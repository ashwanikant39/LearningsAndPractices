jQuery(document).ready(function () {
    Metronic.init();
    TableAdvanced_FAQActive();
    TableAdvanced_FAQInactive();
});


function TableAdvanced_FAQActive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblFAQActive");
...
function TableAdvanced_FAQInactive() {

    if (!jQuery().dataTable) {
        return;
    }

    var table = $("#tblFAQInactive");
