    ...
    public static class FileUploadCheck
    {
        ...
        public static bool isValidFile(byte[] bytFile, FileType flType, String FileContentType)
        {
            ...
            if (flType == FileType.Image)
            {
                ...
                string content = System.Text.Encoding.UTF8.GetString(bytFile);
                bool regCheck = Regex.IsMatch(content, @"<script|<html|<head|<title|<body|<pre|<div|<table|<a\s+href|<img|<plaintext|<cross\-domain\-policy", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Multiline);
        ...
        public static bool isValidImageFile(byte[] bytFile, String FileContentType)
        {
            ...
            if (imgfileExtn == ImageFileExtension.jpg || imgfileExtn == ImageFileExtension.jpeg)
            {
                ...
                //bool myCheck = Regex.IsMatch(content, @"<script|<html|<head|<title|<body|<pre|<div|<table|<a\s+href|<img|<plaintext|<cross\-domain\-policy", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Multiline);
